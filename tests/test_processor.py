...
class TestProcessor:
    ...
    def test_total_amount_calculation(self):
        ...
        if "Quantity" in sample_data and "UnitPrice" in sample_data:
            sample_data["TotalAmount"] = (
                sample_data["Quantity"] * sample_data["UnitPrice"]
            )
...
class TestErrorHandling:
    ...
    def test_missing_fields_handling(self):
        ...
        if "Quantity" in incomplete_data and "UnitPrice" in incomplete_data:
            incomplete_data["TotalAmount"] = (
                incomplete_data["Quantity"] * incomplete_data["UnitPrice"]
            )
    ...
    def test_zero_values(self):
        ...
        zero_quantity_data = {"InvoiceNo": 536365, "Quantity": 0, "UnitPrice": 2.55}

        total_amount = zero_quantity_data["Quantity"] * zero_quantity_data["UnitPrice"]
        assert total_amount == 0.0

        zero_price_data = {"InvoiceNo": 536366, "Quantity": 5, "UnitPrice": 0.0}
